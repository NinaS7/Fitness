...
/* harmony import */ var _modules_input_tel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/input-tel */ "./js/modules/input-tel.js");
...
var subscriptions = document.querySelector('.subscriptions__wrapper');
var anchors = document.querySelectorAll('.scroll-to');
var videoBtn = document.querySelector('[data-video-button]');
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["onTabs"])();
  Object(_modules_input_tel__WEBPACK_IMPORTED_MODULE_2__["getMask"])();
  ...
  videoBtn.onclick = function (evt) {
    ...
    var div = document.querySelector('div.gym__video');
...
var getMask = function getMask() {
  var MIN_LENGTH = 16;
  var inputTel = document.querySelector('[data-input-tel]');
...
/*!****************************!*\
  !*** ./js/modules/tabs.js ***!
  \****************************/
/*! exports provided: onTabs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onTabs", function() { return onTabs; });
var subsBtns = document.querySelectorAll('.subscriptions__button');
var subsTabs = document.querySelectorAll('.subscriptions__tab');

var onTabs = function onTabs() {
  subsBtns.forEach(function (item) {
    return item.addEventListener('click', function (evt) {
      evt.preventDefault();
      var id = evt.target.getAttribute('href').replace('#', '');
      subsBtns.forEach(function (child) {
        return child.classList.remove('subscriptions__button--active');
      });
      subsTabs.forEach(function (child) {
        return child.classList.remove('subscriptions__tab--active');
      });
